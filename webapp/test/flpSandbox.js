		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SalesOrder",
									"targetURL": "#apsalesoreder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apsalesoreder-display": {
								"semanticObject": "apsalesoreder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.salesoreder",
									"url": sap.ui.require.toUrl("ap/salesoreder")
								}
							}
						}
					}
